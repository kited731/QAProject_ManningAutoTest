...
import Util.HandleClickAndCollect;
...
public class PaymentTest {
    ...
    public void start() {
        ...
        // Details")).click();
        page.navigate("https://www.mannings.com.hk/en/strepsils-sugarfree-lemon-lozenge-16pcs/p/492595");
        HandleClickAndCollect.AddToCart(page);
        HandleClickAndCollect.selectClickNCollect(page);
        HandleClickAndCollect.increaseQtyNCheckoutSecurely(page);
        HandleClickAndCollect.guestCheckout(page);
        String email = "abc@gmail.com";
        String fullname = "John Doe";
        String mobile = "61236123";
        // HandleClickAndCollect.CNCInputCheckOutInfo(page, email, fullname, mobile);
        // HandlePopUp.closePromotionPopUp(page);
        // HandlePopUp.closeCookiesPopUp(page);
        HandlePaymentMethod.selectPaymentMethod(page, 1);
        page.pause();
